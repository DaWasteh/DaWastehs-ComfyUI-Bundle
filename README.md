# DaWasteh – konsolidierte ComfyUI-Workflows · v0.8.5
...
- 9 lokale MiniMax-H3-Workflows: FL2VA, Ref2VA, automatische Audio-/Videolänge sowie ein Complete-Song-Director, der lange Songs seriell in höchstens 15 Sekunden lange H3-Szenen zerlegt. v0.8.4 ergänzt einen standardmäßigen Sängerinnen-Identity-Lock, feste Seed-Basis, ein garantiertes Referenzbild als Frame 1 und ein eindeutig benanntes `joined_video.<container>` **mit** unverändertem Originalaudio; nur `joined_video_silent.mp4` bleibt als interner Zwischenstand tonlos
