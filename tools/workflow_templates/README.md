...
The video files were copied byte-for-byte from `comfyui-workflow-templates-json 0.1.43`, installed with ComfyUI `0.32.0`, on 2026-08-13. The MiniMax Music 3 template was pinned byte-for-byte from the official upstream repository on 2026-08-14. They are committed so workflow generation remains deterministic when upstream templates change.
